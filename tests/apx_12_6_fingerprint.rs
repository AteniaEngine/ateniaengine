...
fn apx_12_6_fingerprint_stable() {
    let fp1 = ExecFingerprint::new("matmul_kernel", (32, 32, 1), (16, 16, 1), 2048, 4);

    let fp2 = ExecFingerprint::new("matmul_kernel", (32, 32, 1), (16, 16, 1), 2048, 4);

    // They must be identical
    assert_eq!(fp1.hash64(), fp2.hash64());

    // If we change something, the fingerprint changes
    let fp3 = ExecFingerprint::new("matmul_kernel", (16, 16, 1), (16, 16, 1), 2048, 4);
...
fn apx_12_6_fingerprint_basic_kernel() {
    let fp = KernelFingerprint::new(12345, (16, 16, 1), (8, 8, 1), 2048, 32, 20, 32, "TEST");
